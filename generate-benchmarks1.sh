...
generate-transition(){
     ...
     out_file=$4
#---------------------------------------
     output_place_range=5
     if [[ $range  -eq  100 ]]; then
...
generate-benchmarks  $benchmark_dir/10-replace 10 1000
